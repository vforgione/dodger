...
class ShipmentResource(ModelResource):
    ...
    # foreign keys
    purchase_order = fields.ForeignKey('apps.dat.api.PurchaseOrderResource', 'purchase_order')
...
class ShipmentProductResource(ModelResource):
    ...
    product = fields.ForeignKey('apps.dat.api.PurchaseOrderProductResource', 'product')

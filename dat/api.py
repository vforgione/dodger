...
class PurchaseOrderResource(ModelResource):
    ...
    dat_member = fields.ForeignKey('dodger.api.UserResource', 'dat_member')
...
class PurchaseOrderProductResource(ModelResource):
    ...
    product = fields.ForeignKey('inventory_manager.api.ProductResource', 'product')

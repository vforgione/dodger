...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseOrder.expected_arrival'
        db.delete_column(u'app_purchaseorder', 'expected_arrival')


    def backwards(self, orm):
        # Adding field 'PurchaseOrder.expected_arrival'
        db.add_column(u'app_purchaseorder', 'expected_arrival',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sku', fields ['mfr_sku']
        db.create_unique(u'app_sku', ['mfr_sku'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sku', fields ['mfr_sku']
        db.delete_unique(u'app_sku', ['mfr_sku'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.tracking_url'
        db.add_column(u'app_purchaseorder', 'tracking_url',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.tracking_url'
        db.delete_column(u'app_purchaseorder', 'tracking_url')

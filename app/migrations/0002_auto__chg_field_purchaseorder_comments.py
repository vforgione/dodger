...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseOrder.comments'
        db.alter_column(u'app_purchaseorder', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'PurchaseOrder.comments'
        db.alter_column(u'app_purchaseorder', 'comments', self.gf('django.db.models.fields.TextField')(default=''))

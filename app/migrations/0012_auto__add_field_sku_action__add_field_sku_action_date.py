...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sku.action'
        db.add_column(u'app_sku', 'action',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sku.action_date'
        db.add_column(u'app_sku', 'action_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sku.action'
        db.delete_column(u'app_sku', 'action')

        # Deleting field 'Sku.action_date'
        db.delete_column(u'app_sku', 'action_date')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrderLineItem.unit_cost'
        db.add_column(u'app_purchaseorderlineitem', 'unit_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Sku.price'
        db.delete_column(u'app_sku', 'price')


    def backwards(self, orm):
        # Deleting field 'PurchaseOrderLineItem.unit_cost'
        db.delete_column(u'app_purchaseorderlineitem', 'unit_cost')

        # Adding field 'Sku.price'
        db.add_column(u'app_sku', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrder.shipping_cost'
        db.add_column(u'app_purchaseorder', 'shipping_cost',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrder.shipping_cost'
        db.delete_column(u'app_purchaseorder', 'shipping_cost')

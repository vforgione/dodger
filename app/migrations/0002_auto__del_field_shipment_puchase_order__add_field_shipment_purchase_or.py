...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shipment.puchase_order'
        db.delete_column(u'app_shipment', 'puchase_order_id')

        # Adding field 'Shipment.purchase_order'
        db.add_column(u'app_shipment', 'purchase_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.PurchaseOrder']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Shipment.puchase_order'
        db.add_column(u'app_shipment', 'puchase_order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.PurchaseOrder']),
                      keep_default=False)

        # Deleting field 'Shipment.purchase_order'
        db.delete_column(u'app_shipment', 'purchase_order_id')
